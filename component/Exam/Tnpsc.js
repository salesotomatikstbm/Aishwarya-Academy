...
const TnpscExam = () => {
  ...
  const filteredCourses = courseDataArray.filter((item) => item.category === "TNPSC EXAMS");
        ...
        <div className="row wow fadeInUp">
          <div className="col-xl-7 col-xxl-6 col-md-8 col-lg-6 m-auto text-center">
            <div className="tf__heading_area mb-4">
              <h5>OUR TNPCS COURSES</h5>
              <h2>TNPSC Course Exam Covered</h2> {/* Updated Title */}
            </div>
          </div>
        </div>
